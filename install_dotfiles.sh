...
read response 
if [[ "$response" == [yY] ]]; then
    curl -O --output-dir $HOME/ https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.1/Iosevka.tar.xz && sudo tar xvf $HOME/Iosevka.tar.xz -C / usr/share/fonts/
